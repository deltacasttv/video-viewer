...
int main(int argc, char** argv) 
{
   ...
   std::thread viewerthread(render_video, std::ref(viewer), 1920, 1080, "My window", texture_width, texture_height, Deltacast::VideoViewer::InputFormat::bgr_444_8_le_msb, 10, std::ref(stop), std::ref(synchronisation_cv), std::ref(synchronisation_mutex));
#else
   ...
   std::thread pattern_generator(pattern_thread, std::ref(viewer), texture_width, texture_height, Deltacast::ColorBar::PixelFormat::bgr_444_8_le_msb, std::ref(stop), std::ref(synchronisation_cv), std::ref(synchronisation_mutex));
