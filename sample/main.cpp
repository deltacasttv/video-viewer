...
int main(int argc, char** argv) 
{
   ...
   std::thread viewerthread(render_video, std::ref(viewer), 800, 600, "My window", texture_width, texture_height, Deltacast::VideoViewer::InputFormat::ycbcr_444_8, 10, std::ref(stop), std::ref(synchronisation_cv), std::ref(synchronisation_mutex));
#else
